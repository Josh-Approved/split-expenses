/**
 * Tip-jar store product ids for Split Expenses — app-owned (NOT synced from the
...
export const TIP_PRODUCT_IDS = [
  'com.joshapproved.splitexpenses.tip.tier1',
  'com.joshapproved.splitexpenses.tip.tier2',
  'com.joshapproved.splitexpenses.tip.tier3',
  'com.joshapproved.splitexpenses.tip.tier4',
  'com.joshapproved.splitexpenses.tip.tier5',
] as const;

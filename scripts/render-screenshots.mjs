...
//   ios     — 1320 x 2868   (Apple 6.9" iPhone 17 Pro Max — the largest iPhone size;
//                            upload to the 6.9" shelf and ASC scales it down to every
//                            smaller iPhone display. One set covers them all.)
//   ipad          — 2064 x 2752   (Apple 13" iPad — REQUIRED when supportsTablet:true)
//   android       — 1080 x 1920   (Google Play phone)
//   androidTablet — 1600 x 2560   (Google Play 10" tablet; one set fills the 7" + 10" slots)
...
const SURFACES = {
  ios:     { surface: 'iphone',  width: 1320, height: 2868 },
  ipad:    { surface: 'ipad',    width: 2064, height: 2752 },
  android: { surface: 'android', width: 1080, height: 1920 },
  androidTablet: { surface: 'android-tablet', width: 1600, height: 2560 },
